...
export function AboutSection() {
  ...
  return (
    ...
    >
      <motion.div
        style={{ y: y2 }}
        className="absolute top-20 -right-32 w-[500px] h-[500px] rounded-full bg-gold-500/5 blur-3xl"
      />
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="relative aspect-[4/5] rounded-3xl overflow-hidden glass preserve-3d">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center">
                <div className="w-48 h-48 rounded-full bg-gold-gradient flex items-center justify-center mx-auto mb-6 glow-gold">
                  <span className="font-display text-7xl font-bold text-neutral-900">
                    JD
                  </span>
                </div>
            ...
            <motion.div
              ...
              className="absolute top-6 right-6 glass px-3 py-2 rounded-full text-xs flex items-center gap-2"
            >
            ...
            <motion.div
              ...
              className="absolute bottom-6 left-6 glass px-3 py-2 rounded-full text-xs flex items-center gap-2"
            >
          ...
          <motion.div
            ...
            className="absolute -bottom-8 -left-8 glass p-5 rounded-2xl glow-gold max-w-[220px]"
          >
